...
public final class FragmentUnavailableBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentUnavailableBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static FragmentUnavailableBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentUnavailableBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_unavailable, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentUnavailableBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentUnavailableBinding((ConstraintLayout) rootView, constraintLayout,
