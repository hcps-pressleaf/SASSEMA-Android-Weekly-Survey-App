...
public final class PsqiQuestionTemplateBinding implements ViewBinding {
  @NonNull
  ...
  private PsqiQuestionTemplateBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static PsqiQuestionTemplateBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static PsqiQuestionTemplateBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.psqi_question_template, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static PsqiQuestionTemplateBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new PsqiQuestionTemplateBinding((ConstraintLayout) rootView, radioButton1,
