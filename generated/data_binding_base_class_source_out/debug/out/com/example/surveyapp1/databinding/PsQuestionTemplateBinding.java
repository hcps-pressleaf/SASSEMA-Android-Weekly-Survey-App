...
public final class PsQuestionTemplateBinding implements ViewBinding {
  @NonNull
  ...
  private PsQuestionTemplateBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static PsQuestionTemplateBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static PsQuestionTemplateBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.ps_question_template, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static PsQuestionTemplateBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new PsQuestionTemplateBinding((ConstraintLayout) rootView, radioButton1, radioButton2,
          radioButton3, radioButton4, radioButton5, radiogroup);
    }
