...
public final class FragmentLastBinding implements ViewBinding {
  ...
  private FragmentLastBinding(@NonNull ConstraintLayout rootView,
  ...
  public static FragmentLastBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_last, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentLastBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentLastBinding((ConstraintLayout) rootView, constraintLayout,
          firstFragmentConstraint, imageView2, textView2);
    }
