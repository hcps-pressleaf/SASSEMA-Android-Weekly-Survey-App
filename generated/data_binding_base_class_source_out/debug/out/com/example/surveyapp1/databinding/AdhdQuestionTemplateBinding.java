...
public final class AdhdQuestionTemplateBinding implements ViewBinding {
  @NonNull
  ...
  private AdhdQuestionTemplateBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static AdhdQuestionTemplateBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static AdhdQuestionTemplateBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.adhd_question_template, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static AdhdQuestionTemplateBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AdhdQuestionTemplateBinding((ConstraintLayout) rootView, radioButton1,
